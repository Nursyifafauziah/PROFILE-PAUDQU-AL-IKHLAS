...
$sql = "SELECT * FROM kegiatan WHERE id = '$id' AND tipe = 'berita'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($query_update) === TRUE) {
        $_SESSION['pesan'] = "Data kegiatan berhasil diubah!";
        header("Location: kegiatan.php");
        exit();
    } else {
...
<div class="card border-0 shadow-sm rounded-4">
    <div class="card-body p-4">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <hr>
            <div class="text-end">
                <button type="submit" class="btn btn-primary px-4 rounded-pill"><i class="fas fa-save me-1"></i> Update Berita</button>
            </div>
        </form>
    </div>
</div>
