...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['gambar']) && $_FILES['gambar']['error'] == 0) {
        ...
        if (in_array($ext, $allowed)) {
            $new_filename = 'kegiatan_' . time() . '_' . rand(1000, 9999) . '.' . $ext;
    ...
    if ($conn->query($sql) === TRUE) {
        $_SESSION['pesan'] = "Data kegiatan berhasil ditambahkan!";
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="fw-bold mb-0">Tambah Kegiatan</h3>
    <a href="kegiatan.php" class="btn btn-secondary rounded-pill px-4"><i class="fas fa-arrow-left me-1"></i> Kembali</a>
</div>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        <label for="konten" class="form-label fw-bold">Isi Berita</label>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <small class="text-muted d-block mb-3">Format diperbolehkan: JPG, PNG, GIF. Disarankan untuk Berita.</small>
            ...
            <hr>
            <div class="text-end">
                <button type="submit" class="btn btn-success px-4 rounded-pill"><i class="fas fa-save me-1"></i> Simpan Kegiatan</button>
            </div>
        </form>
    </div>
</div>
